...
export const getEditedMetric = (state: TApplicationState) => state.settings.editedMetric;
export const isEditedMetricModified = (state: TApplicationState) => state.settings.isModified;
